...
class ReportCollection:
    ...
    def __setitem__(self, report: Report) -> None:
        ...
        assert report.report_bytearray is not None, "Report bytearray must be set before adding."
    ...
    def iter_report_bytes(self) -> Iterator[bytes]:
        for report in self.reports:
            assert report.report_bytearray is not None, "Report bytearray must be set before iterating."
